...
helper_pdu_encode_func_t *const helper_pdu_encode[] = {
	...
	[LL_FEATURE_EXT_REQ] = helper_pdu_encode_feature_ext_req,
	[LL_FEATURE_EXT_RSP] = helper_pdu_encode_feature_ext_rsp,
...
helper_pdu_verify_func_t *const helper_pdu_verify[] = {
	...
	[LL_FEATURE_EXT_REQ] = helper_pdu_verify_feature_ext_req,
	[LL_FEATURE_EXT_RSP] = helper_pdu_verify_feature_ext_rsp,
...
helper_pdu_ntf_verify_func_t *const helper_pdu_ntf_verify[] = {
	...
	[LL_FEATURE_RSP] = NULL,
	[LL_FEATURE_EXT_REQ] = NULL,
	[LL_FEATURE_EXT_RSP] = NULL,
